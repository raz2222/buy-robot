...
export default function ThankYou() {
  ...
  return (
    <>
      <section className="bg-ink pb-16 pt-28 text-ink-foreground md:pt-36">
        <div className="container max-w-2xl text-center">
          <span className="mx-auto grid size-14 place-items-center rounded-full bg-signal text-signal-foreground">
